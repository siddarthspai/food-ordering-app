...
import com.siddarthspai.restaurantapp.adapter.RestaurantMenuAdapter
import com.siddarthspai.restaurantapp.model.RestaurantMenu
...
class RestaurantMenuActivity : AppCompatActivity() {
    ...
    override fun onBackPressed() {
        ...
        if(menuAdapter.getSelectedItemCount()>0) {
            ...
            alterDialog.setMessage("Going back will remove everything from the cart")
