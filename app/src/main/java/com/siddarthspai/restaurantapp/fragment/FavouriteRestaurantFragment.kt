package com.siddarthspai.restaurantapp.fragment
...
import com.siddarthspai.restaurantapp.adapter.DashboardFragmentAdapter
import com.siddarthspai.restaurantapp.database.RestaurantDatabase
import com.siddarthspai.restaurantapp.database.RestaurantEntity
import com.siddarthspai.restaurantapp.model.Restaurant
import com.siddarthspai.restaurantapp.utils.ConnectionManager
...
class FavouriteRestaurantFragment(val contextParam:Context) : Fragment() {
    ...
    fun fetchData(){
        ...
        }else
        {
            ...
            alterDialog.setMessage("Internet Connection cannot be established")
